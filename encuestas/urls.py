...
urlpatterns = [
    # Vistas de panel (admin) - DEBEN IR PRIMERO para evitar conflicto con <str:codigo>
    ...
    # Vistas públicas (participantes) - AL FINAL porque <str:codigo> captura cualquier string
